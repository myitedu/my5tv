...
<div class="container-fluid">
    ...
    <div id="mybuttons">
        <table>
            <tr>
                <td colspan="3"> <button data-direction="top" class="btn btn-danger yourbuttons">^</button></td>
            </tr>
            <tr>
                <td><button data-direction="left" class="btn btn-info yourbuttons">&lt;</button></td>
                <td>
                    &nbsp;
                    &nbsp;
                    &nbsp;
                ...
                <td><button data-direction="right" class="btn btn-info yourbuttons">&gt;</button></td>
            </tr>
            <tr>
                <td colspan="3"> <button data-direction="bottom" class="btn btn-danger yourbuttons">v</button></td>
            </tr>
        </table>
    </div>
    <div class="mytext">
...
<script>
    $(function (){
        $(".yourbuttons").click(function (){
            ...
            let left = $("#mybox").css("left");
            let top = $("#mybox").css("top");
            left = parseInt(left);
            top = parseInt(top);
            let steps = 100;
        ...
        function changeElementPosition(direction){
            if (direction=='left'){
                let left_size = $("#mybox").css("left");
                left_size = parseInt(left_size);
                left_size+=100;
                $("#mybox").css("left", left_size+"px");
            }
            if (direction=='top'){
                let top_size = $("#mybox").css("top");
                top_size = parseInt(top_size);
                top_size+=100;
                $("#mybox").css("top", top_size+"px");
            }
        }
    });
</script>
