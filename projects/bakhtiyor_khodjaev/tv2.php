...
<div id="living_room">
  <?php if($open=='menu'){?>
    ...
    <?php }?>
    <iframe id="youtube" src="<?php echo $videos[$video];?>" frameborder="0" allow="accelerometer; autoplay=1; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
