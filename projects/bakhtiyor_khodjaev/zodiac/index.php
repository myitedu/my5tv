...
<div id="container-fluid">
    ...
    <div class="garaskoplar">
        <?php
        foreach ($zadiaks1 as $id=>$zadiak1) {
            ?>
            <div class="zadiaklar1">
                <div class="zadiak">
                    <a href="index.php?zadiak=<?=$id;?>"><img src="<?php echo $zadiak1 ?>"></a>
                </div>
            </div>
            <?php
        }
        ...
        <?php
        foreach ($zadiaks2 as $id=>$zadiak2) {
            ?>
            <div class="zadiaklar3">
                <div class="zadiak">
                    <a href="index.php?zadiak=<?=$id;?>"><img src="<?php echo $zadiak2 ?>"></a>
                </div>
            </div>
            <?php
        }
